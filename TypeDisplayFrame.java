 ...
 * @author bala
 */
public class TypeDisplayFrame extends javax.swing.JFrame {
    ...
    private static int SUCN_SIZE_COL = 4;
    private static int DEL_SIZE_COL = 5;
    private static int DISCH_COL = 6;
    private static int HEAD_COL = 7;
    private static int EFF_COL = 8;
    private static int CURR_COL = 9;
    private static int HEAD_LOWER_COL = 10;
    private static int HEAD_UPPER_COL = 11;
    private static int PHASE_COL = 12;
    private static int VOLTAGE_COL = 13;
    ...
    private void initComponents() {
        ...
        typesTable.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[]{
                    "ID", "Type", "H.P.", "kW", "Sucn.Size,mm", "Del.size,mm", "Disch. , lps", "TotalHead,mWC", "OA Eff. , %", "Max.Current ,A", "HeadLower,mWC", "HeadUpper,mWC", "Phase", "Voltage,V"
                }) {
    ...
    private void typesTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_typesTableMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            try {
                ...
                List list = q.list();
                int i = Integer.parseInt((typesTable.getValueAt(selectedRow, 0).toString()));
                selectedIDField.setText(String.valueOf(i));
                //             editing = true;
                //           typesTable.setEnabled(editing);
                typesTable.setEditingRow(selectedRow);

                PumpType t = (PumpType) session.get(PumpType.class, i);
                t.setDischarge(Double.parseDouble(typesTable.getValueAt(selectedRow, 1).toString()));
    ...
    private void loadButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadButtonActionPerformed
        ...
        entryPanel.getSuctionSizeField().setText(typesTable.getValueAt(row, SUCN_SIZE_COL).toString());
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        try {
            ...
            type.setType((typesTable.getValueAt(row, this.TYPE_COL)).toString());
            ...
            type.setSucnSize(Double.parseDouble(typesTable.getValueAt(row, this.SUCN_SIZE_COL).toString()));
            ...
            type.setMcurrent(Double.parseDouble(typesTable.getValueAt(row, this.CURR_COL).toString()));
    ...
    public void getTypeValuesAndDisplay() {
        ...
        try {
            ...
            Object[][] data = new Object[list.size()][typesTable.getColumnCount()];
            for (Object ob : list) {
               ...
               data[i][SUCN_SIZE_COL] = type.getSucnSize();
                ...
                data[i][CURR_COL] = type.getMcurrent();
