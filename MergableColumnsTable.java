...
public class MergableColumnsTable extends JPanel {
...
//                g2D.drawOval(0, 0,  getWidth(),0);
            }
        };
        // jTable.setFillsViewportHeight(true);
        jTable.setPreferredSize(new Dimension(getWidth(),
                jTable.getRowCount() * (jTable.getRowHeight())));
        jTable.setMinimumSize(new Dimension(getWidth(), jTable.getRowCount() * jTable.getRowHeight()));
            ...
            public void paintComponent(Graphics g) {
               ...
               g2D.drawLine(0,getHeight()-1,getWidth()-1,getHeight()-1);
                ...
                for (int i = 0; i < getColumnModel().getColumnCount(); i++) {
                    ...
                    //}
//  g2D.drawLine(x + getColumnModel().getColumn(i).getWidth() - 1, getHeight(), x, getHeight());
                    ...
                    // float offsetInc= getColumnModel().getColumn(i).getWidth()/4;
        ...
        //header.setMinimumSize(new Dimension(this.getWidth(), 52));
        header.setPreferredSize(new Dimension(this.getWidth(), 100));
        // header.setMaximumSize(new Dimension(this.getWidth(), 61));
        header.setTable(jTable);
        jTable.setTableHeader(header);
        jTable.setFont(new Font("SansSerif", Font.PLAIN, 8));
        add(header, BorderLayout.NORTH);// "grow,span,wrap");
        add(jTable, BorderLayout.SOUTH);// "grow,span,wrap");
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            f.setLayout(new BorderLayout()); //MigLayout("",
            f.add(table);//container);
